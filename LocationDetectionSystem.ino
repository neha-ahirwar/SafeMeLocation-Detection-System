...
const String EMERGENCY_PHONE = "+919566597161";
//--------------------------------------------------------------
...
void loop()
{
  ...
  {
    updateflag=0;
    Serial.println("Neha is in Danger!!");
...
void makeCall()
{
  Serial.println("Emergency calling....");
